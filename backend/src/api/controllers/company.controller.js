...
//     try {
//         // Update booking status and populate related data
//         const result = await Booking.findByIdAndUpdate(
//             bookingId,
//             { $set: { status: 'declined' } },
//             { new: true }
//         ).populate('clientId').populate('companyId');

//         // Send email to client
//         if (result && result.clientId && result.companyId) {
//             const clientEmail = result.clientId.email; // Client email
//             const companyEmail = result.companyId.email; // Company email

//             const subject = 'Booking Request Declined';
//             const text = `We regret to inform you that your booking request has been declined. Booking ID: ${bookingId}`;

//             await sgMail.send({
//                 to: clientEmail,
//                 from: companyEmail, // Dynamic company email
//                 subject: subject,
//                 text: text,
//             });
//         }
...
//         // Send email to client
//         if (bookingResults && bookingResults.clientId && bookingResults.companyId) {
//             const clientEmail = bookingResults.clientId.email; // Client email
//             const companyEmail = bookingResults.companyId.email; // Company email

//             const subject = 'Booking Request Approved';
//             const text = `Your booking request has been approved by the company. Booking ID: ${bookingId}`;
